...
export const createProduct = async (req:Request, res:Response)=> {
    ...
    if(!colors || typeof images !== "object"){
    ...
    const missingColors = (colors as string[]).filter((color)=> !(color in images))
...
export const getProducts = async (req:Request, res:Response)=> {
    ...
    const orderBy = (()=>
    {
        ...
        case "desc":
            ...
            break
        case "oldest": 
            return {createAt: Prisma.SortOrder.asc}
            break;
        default: 
            return {createAt: Prisma.SortOrder.desc}
    }
    }
)()
