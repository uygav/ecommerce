  ...
  return (
    <SheetContent>
      ...
      <SheetHeader>
        ...
        <SheetDescription>Fill in the details to add a new product.</SheetDescription>
          <Form {...form}>
            <form className="space-y-8" 
            onSubmit={form.handleSubmit((data)=> mutation.mutate(data), (errors)=> console.log("Validation errors:", errors))}>
              <FormField
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Enter the available colors for the product
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
                  ...
                  <Input
                      ...
                      try {
                        ...
                        if (data.secure_url) {
                            ...
                            toast.error(data.error?.message || "Upload failed! Check Cloudinary preset.")
                          }
                      } catch (error) {
                      console.log(error)
